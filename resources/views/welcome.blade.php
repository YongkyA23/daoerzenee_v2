    ...
    <section class="product-categories">
        <div class="container">
                        ...
                        <div class="col">
                            <div class="product-card">
                                <div class="isicard-atas">
                                    <img src="{{ $product->fotoProduk }}" alt="Product Image"
                                        onerror="this.src='https://via.placeholder.com/150';"
                                        style="border: 0.2vw solid #afda00;">
                                ...
                                <a href="#" class="icon-link"><i
                                        class="bi bi-chevron-double-right rotated-icon"></i></a>
                            </div>
                        </div>
                    @empty
            ...
            <div class="button-container-home">
                <a href="{{ route('products.index') }}" style="color: black; text-decoration: none;">
