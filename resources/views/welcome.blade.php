 ...
 @section('content')
     <section>
         {{-- Paper Background --}}
         <div>
             <img src="{{ asset('photos/SectionPaper.webp') }}" alt="Paper Background" class="section-paper"
                 style="top: 100%; margin-top:-2vw;">
         </div>
                 ...
                 <div class="col-md-8 col-8">
                     <div class="card-body" style="margin: 2vw; padding:0;">
                         ...
                         <p class="card-content">Komunitas kami memberdayakan umat KLMTD (kaum kecil, lemah, miskin,
                             telantar, disabilitas) dengan tujuan untuk membuat produk daur ulang. Mereka membawa semangat
                             partisipasi dengan langkah-langkah kecil yang mencintai dan menyelamatkan bumi melalui
                             prinsip-prinsip 'reuse-reduce-recycle-renew'.</p>
                                     ...
                                     <div class="container">
                                         <div class="row">
                                             ...
                                             <div class="col-md-12 text-center">
                                                 ...
                                                 <p style="font-size: 18px; margin-bottom: 0;">Whats App: 0818-152-242
                                                     (Linawaty)</p>
                                                 <button onclick="copynumber()" class="small-btn"
                                             ...
                                             <div class=" col-md-12 text-center" style="margin-top: 20px;">
                                                 ...
                                                 <img src="{{ asset('photos/mapsLogo.webp') }}" alt="Logo Maps"
                                                     width="50px" height="50px" style="margin-bottom: 10px;">
                                                 <p style="font-size: 18px; margin-bottom: 0;">Jl Cawang Baru No 45, Cawang
                                                     Kapling, Jakarta Timur 13340, Cawang, Kramat Jati, Jakarta Timur, DKI
                                                     Jakarta 203</p>
                                                 <a
