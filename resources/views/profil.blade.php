...
@section('content')
    <section class="banner-section">
        ...
        <div class="banner-image">
            ...
            <div class="banner-text-profil">
                <h1>DAOER ZENEE</h1>
                <p>Komunitas kami memberdayakan umat KLMTD (kaum kecil, lemah, miskin, telantar, disabilitas) dengan tujuan
                    untuk membuat produk daur ulang. Mereka membawa semangat partisipasi dengan langkah-langkah kecil yang
                    mencintai dan menyelamatkan bumi melalui prinsip-prinsip 'reuse-reduce-recycle-renew'.</p>
            </div>
        </div>
    </section>
    ...
    <section class="community-profile">
        ...
        <div class="profile-section">
            <div class="profile-text">
                ...
                <p><strong>Lokasi :</strong>{{ $settings->address }}</p>
    ...
    <section class="cardboard-profil">
        ...
        <p class="isi-profil">
            Pada akhir tahun 2005, berawal dari banyaknya kertas sisa percetakan, Daoer Zenee terinspirasi untuk
            memanfaatkan sisa kertas tersebut sebagai media pengembangan kreativitas anak-anak sekolah Minggu Cawang
            Kapling.
        </p>

        <p class="isi-profil">
            Berkembang dari kegiatan tersebut, Daoer Zenee mengadakan kegiatan fundraising yang menunjang berbagai acara
            Sekolah Minggu dan muda mudi Katolik.
        </p>

        <p class="isi-profil">
            Seiring berjalannya waktu, karya Daoer Zenee mulai dikenali orang secara lisan dan berbagai macam forum.
            Popilaritas Daoer Zenee juga semakin meningkat melalui media sosial disaat pandemi.
        </p>

        <p class="isi-profil">
            Karya Daoer zenee seringkali diminta untuk membuat dekorasi diberbagai acara lintas paroki dan rutan/penjara.
            Selebihnya, Kami juga aktif dalam mengikuti berbagai lomba kreativitas dari bahan daur ulang.
        </p>
    </section>
